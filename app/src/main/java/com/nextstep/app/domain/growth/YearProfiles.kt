...
object YearProfiles {
    ...
    val all: List<YearProfile> = listOf(
        ...
        preschool(0, "대화와 몸 놀이가 전부인 해", INFANT, 0, k("말 걸기·눈 맞추기", PLAY, 7, 10), k("그림책 보여 주기", READ, 7, 5), k("배밀이·몸 놀이", PLAY, 7, 15)),
        preschool(1, "첫 단어가 나오는 해", INFANT, 0, k("그림책 읽어 주기", READ, 7, 10), k("산책·몸 놀이", PLAY, 7, 30), k("노래·소리 놀이", PLAY, 5, 10)),
        preschool(2, "말이 트이는 해", INFANT, 0, k("그림책 하루 3권", READ, 7, 15), k("역할 놀이", PLAY, 5, 20), k("끼적이기·색칠", PLAY, 3, 10)),
