...
object ContentClassifier {
    ...
    val subjectHints: Map<String, List<String>> = linkedMapOf(
        "수학" to listOf("수학", "수1", "수2", "수I", "수II", "미적", "확통", "기하", "방정식", "함수", "도형", "인수분해", "다항식", "집합", "명제", "지수", "로그함수", "지수와 로그", "상용로그", "삼각", "수열", "극한", "미분", "적분", "확률", "통계", "정수", "유리수", "무리수", "제곱근", "피타고라스", "닮음", "원주각", "연립", "부등식", "좌표", "비례", "분수", "소수", "약수", "배수", "각도", "넓이", "부피"),
        ...
        "과학" to listOf("과학", "물리", "화학", "생물", "생명과학", "지구과학", "지학", "운동", "힘과 운동", "에너지", "전기", "자기", "빛과 파동", "파동", "원소", "주기율표", "화학 반응", "산과 염기", "세포", "유전", "광합성", "호흡", "생태계", "지층", "화산", "지진", "판구조", "태양계", "별자리", "기권", "수권", "날씨", "물질", "혼합물", "용해도", "열에너지", "밀도"),
        "사회" to listOf("사회", "지리", "일반사회", "정치", "경제", "법률", "법과 정치", "문화", "인권", "헌법", "민주주의", "시장", "수요", "공급", "무역", "환율", "기후", "지형", "인구", "도시", "자원", "국제", "사회문화", "생활과 윤리", "윤리"),
