...
object YearPlans {
    ...
    private val plans: Map<String, List<YearTask>> = mapOf(
        ...
        "a0" to listOf(
            ...
            pa(BODY, "영유아 건강검진 1~3차", "생후 14~35일, 4~6개월, 9~12개월"), pa(BODY, "국가 예방접종", "B형간염·BCG부터 2·4·6개월 일정대로"),
        ...
        "a1" to listOf(
            ...
            pa(BODY, "영유아 검진 4차", "18~24개월, 발달선별검사(K-DST) 함께"), pa(BODY, "돌 전후 예방접종", "MMR·수두·일본뇌염"), pa(BODY, "구강검진 1차", "18~29개월"),
        ...
        "a2" to listOf(
            ...
            pa(BODY, "영유아 검진 5차", "30~36개월, 말이 늦으면 이때 상담"),
            ca(LIFE, "혼자 숟가락으로 먹기", "흘려도 괜찮아요"), ta(LIFE, "배변 연습", "아이가 신호를 보일 때 시작"), pa(LIFE, "화면은 하루 1시간 안", "만 2세부터, 부모와 함께 보기"),
            YearTask(LIFE, YearTerm.SECOND, "유치원 알아보기", "만 3세반은 11월 '처음학교로' 접수", YearDoer.PARENT),
        ),
        ...
        "a3" to listOf(
            ...
            ta(BODY, "바깥놀이 1시간", "놀이터·산책"), pa(BODY, "영유아 검진 6차·구강검진", "42~48개월"),
        ...
        "a5" to listOf(
            ...
            pa(BODY, "영유아 검진 7차", "54~60개월, 시력 확인"),
        ...
        "a6" to listOf(
            ...
            pa(BODY, "영유아 검진 8차", "66~71개월"), YearTask(BODY, YearTerm.SECOND, "시력·치과 치료 마치기", "입학 전에", YearDoer.PARENT),
            ca(LIFE, "20분 앉아 있기", "그림책·퍼즐로 연습"), ca(LIFE, "혼자 화장실·옷 입기", "학교생활의 기본"),
            YearTask(LIFE, YearTerm.SECOND, "취학통지서·예비소집", "12월 통지서, 1월 예비소집", YearDoer.PARENT), YearTask(LIFE, YearTerm.SECOND, "늘봄·돌봄 신청", "맞벌이라면 1~2월", YearDoer.PARENT),
        ),
        "e1" to listOf(
            ...
            YearTask(LIFE, YearTerm.ALL_YEAR, "알림장 확인", "매일 가방 싸기 전", YearDoer.TOGETHER), a(LIFE, "준비물 스스로 챙기기", "전날 밤"), a(LIFE, "9시에 자기", "잠이 공부예요"),
            a(BODY, "줄넘기", "하루 10번부터"), YearTask(BODY, YearTerm.ALL_YEAR, "물놀이·수영 경험", "생존수영 전에", YearDoer.TOGETHER),
        ),
        "e2" to listOf(
        ...
        "e4" to listOf(
            ...
            YearTask(LIFE, YearTerm.ALL_YEAR, "스마트폰 규칙", "가족과 함께 정하기", YearDoer.TOGETHER),
        ...
        "e6" to listOf(
            ...
            YearTask(BODY, YearTerm.ALL_YEAR, "사춘기 몸 변화 알기", "가족과 이야기", YearDoer.TOGETHER),
        ),
        "m1" to listOf(
