...
object YearPlans {
    ...
    private val plans: Map<String, List<YearTask>> = mapOf(
        ...
        "e6" to listOf(
            ...
            s2(LIFE, "중학교 배정 원서", "12월 원서, 1월 말 발표(서울 기준)", P),
        ...
        "m1" to listOf(
            ...
            a(LIFE, "밤 11시 전 잠자리", "청소년 권장 수면 8~10시간"), a(LIFE, "스마트폰 규칙 다시 정하기", "가족과 함께", T),
        ),
        ...
        "m3" to listOf(
            ...
            s1(CAREER, "고등학교 종류 알아보기", "일반고·특목고·자사고·특성화고", T), s1(CAREER, "영재학교·과학고 일정", "관심 있다면: 영재학교 4~5월, 과학고 8월", T),
        ...
        "h1" to listOf(
            ...
            s2(CAREER, "2학년 선택과목 수강신청", "희망 진로와 함께", T),
