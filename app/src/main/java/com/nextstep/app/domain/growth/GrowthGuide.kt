...
object GrowthGuide {
    ...
    fun forStage(stage: GrowthStage): StageGuide = when (stage) {
        GrowthStage.NEWBORN -> StageGuide(
            ...
            mentorTips = listOf("이 시기엔 멘토보다 부모의 휴식이 중요합니다", "아이보다 부모에게 정보를 주세요", "접종·검진·대기 신청 같은 놓치기 쉬운 일정을 대신 챙겨 주세요"),
        ...
        GrowthStage.TODDLER -> StageGuide(
            ...
            mentorTips = listOf("놀이 교실·문화센터 수준의 짧은 활동만", "글자·숫자 조기 학습보다 대화량이 우선", "언어 발달이 늦어 보이면 검진·상담을 권하세요"),
