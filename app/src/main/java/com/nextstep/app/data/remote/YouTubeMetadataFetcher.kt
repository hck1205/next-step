...
data class YouTubeMetadata(val title: String, val channel: String, val thumbnailUrl: String)
...
class YouTubeMetadataFetcher {
    suspend fun fetch(videoUrl: String): YouTubeMetadata? = withContext(Dispatchers.IO) {
        try {
