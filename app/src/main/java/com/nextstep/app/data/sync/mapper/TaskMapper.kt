...
object TaskMapper : EntityMapper<TaskEntity> {
    ...
    override fun fromMap(id: String, data: Map<String, Any?>): TaskEntity = TaskEntity(
        ...
        createdByRole = data.str("createdByRole"), note = data.str("note"), goalId = data.strOrNull("goalId"), doneAt = data.longOrNull("doneAt"), updatedAt = data.long("updatedAt"), deleted = data.bool("deleted"), dirty = false,
    )
}
