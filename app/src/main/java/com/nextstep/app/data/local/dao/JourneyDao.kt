...
@Dao
interface JourneyDao : SyncDao<JourneyItemEntity> {
    ...
    override suspend fun getById(id: String): JourneyItemEntity?
    ...
    override suspend fun upsert(item: JourneyItemEntity)

    @Query("SELECT * FROM journey_items WHERE familyId = :familyId AND dirty = 1")
    override suspend fun getDirty(familyId: String): List<JourneyItemEntity>
