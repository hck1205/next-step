...
class StudentScreenTest {
    ...
    fun preschoolersHaveNoTimerAndTasksComeFirst() {
        ...
        assertEquals(listOf(StudentHomeSection.TASKS, StudentHomeSection.MY_WEEK, StudentHomeSection.ROUTINE, StudentHomeSection.GAME, StudentHomeSection.YEAR, StudentHomeSection.WEEK), s.homeOrder)
    }
