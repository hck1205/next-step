...
class StudentUiLevelTest {
    ...
    fun screenOnlyGrowsWithLevel() {
        ...
        assertEquals(setOf(StudentHomeSection.TIMER, StudentHomeSection.TASKS, StudentHomeSection.WEEK, StudentHomeSection.NOTE, StudentHomeSection.YEAR), StudentUiLevel.SPROUT.sections)
        ...
        assertEquals(setOf(StudentHomeSection.TASKS, StudentHomeSection.WEEK, StudentHomeSection.NOTE, StudentHomeSection.YEAR), StudentUiLevel.SEED.sections)
